...
/obj/structure/roguemachine/titan/proc/recreate_key()
	if(SSroguemachine.key)
		var/obj/item/roguekey/lord/old_master_key = SSroguemachine.key
...
/obj/structure/roguemachine/titan/proc/get_commands()
	. += jointext(command_list, ", ")

/obj/structure/roguemachine/titan/proc/is_valid_mob(mob/living/carbon/human/checked_mob)
...
/obj/structure/roguemachine/titan/proc/is_worthy(mob/living/carbon/human/checked_mob)
	if(SSticker.rulermob != checked_mob)
...
/obj/structure/roguemachine/titan/proc/has_crown(mob/living/carbon/human/checked_mob)
	if(!checked_mob.head || !istype(checked_mob.head, /obj/item/clothing/head/roguetown/crown/serpcrown))
...
/obj/structure/roguemachine/titan/proc/check_cooldown(mob/living/carbon/human/user)
...
/obj/structure/roguemachine/titan/proc/recognize_command(mob/living/carbon/human/user, message)
...
/// States all commands
/obj/structure/roguemachine/titan/proc/help()
	var/commands = get_commands()
	say("My commands are: [commands]")
	playsound(src, 'sound/misc/machinelong.ogg', 100, FALSE, -1)

/// Tries summoning the crown to the user's hand
/obj/structure/roguemachine/titan/proc/summon_crown(mob/living/carbon/human/user)
...
/obj/structure/roguemachine/titan/proc/summon_key(mob/living/carbon/human/user)
	var/obj/item/roguekey/lord/master_key = SSroguemachine.key
...
/obj/structure/roguemachine/titan/proc/set_taxes(mob/living/carbon/human/user)
	...
	if(newtax)
		...
		priority_announce("The new tax in Azuria shall be [newtax] percent.", "[user.real_name], The Generous [user.get_role_title()] Decrees", 'sound/misc/alert.ogg', "Captain")
	reset_mode()

/// Changes the job of a nearby mob
/obj/structure/roguemachine/titan/proc/change_position(mob/living/carbon/human/user)
	if(!Adjacent(user))
		return
